...
- `morph_brain` is compiled into `Pet 2.exe`; it is not a sidecar. The generated topology is pinned to colleague commit `3c6e27e3b55e4aff1d6c2c254713cdbd79099715` and contains `526` neurons, `17,475` synapses and `57` populations. No Node, IPC or network call exists in the desktop runtime.
