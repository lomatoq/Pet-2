...
impl BehaviorProgramId {
    /// Programs that ask the user to participate, including object-play bids.
    #[must_use]
    pub fn requests_user_attention(self) -> bool {
        self.family() == ProgramFamily::AffiliationSocial
            || matches!(
                self,
